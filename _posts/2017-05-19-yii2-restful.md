---
title: 基于yii2用restful设计接口
date: 2017-05-19 08:00
updated: 2017-05-19 08:00
---

`好久没写了，最近在玩yii2的restful. 分享给大家。`


<!-- toc -->


`源码开源在`[halfstring/yii2-basic-restful](https://github.com/halfstring/yii2-basic-restful)  
`源码依据 `[yiisoft/yii2-app-basic](https://github.com/yiisoft/yii2-app-basic) `修改而来。`
...
在啰嗦一遍，文章所有源码见  [halfstring/yii2-basic-restful](https://github.com/halfstring/yii2-basic-restful)  ^ _ ^
